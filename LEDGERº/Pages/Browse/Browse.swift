...
struct Browse: View
{
    ...
    var body: some View
    {
        //Divider().navigationBarTitle("LEDGERº", displayMode: .inline).navigationBarItems(leading: (Button(action: {}) {Image(systemName: "line.3.horizontal").imageScale(.large)}))
        NavigationView
        {
            ScrollView
            {
